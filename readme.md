...
P.S. Там был использован 10 секундный time.sleep для основного потока. А также простите, если немного не понял задачу с изменением цена через час в связи с формулировкой. Она решена, но не уверен, точно ли.
